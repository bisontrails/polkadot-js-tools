...
class MarkdownTheme extends theme_1.Theme {
    constructor(renderer, basePath) {
        ...
        if (!('relativeURL' in Handlebars.helpers)) {
            this.application.logger.error('"typedoc-plugin-markdown" needs to be executed from the same location as "typedoc".\n' +
    ...
    getUrls(project) {
        ...
        if (this.application.options.getValue('readme') === 'none') {
            ...
            urls.push(new typedoc_1.UrlMapping(this.indexName + this.fileExt, entryPoint, 'reflection.hbs'));
        }
        else {
    ...
    getNavigation(project) {
        ...
        function getNavigationGroup(reflection) {
            if (reflection.kind === typedoc_1.ReflectionKind.ExternalModule) {
...
MarkdownTheme.MAPPINGS = [
    ...
    {
        kind: [typedoc_1.ReflectionKind.Module, typedoc_1.ReflectionKind.ExternalModule],
        isLeaf: false,
        directory: 'modules',
        template: 'reflection.hbs',
    },
