...
_alias('Lookup::Target', 'AccountId'), // alias for grandpa internal, as used in polkadot
_alias('grandpa::', ''), // specific for session internal
_alias('session::', ''), // specific for staking/slashing.rs internal
_alias('slashing::', ''), // HACK duplication between contracts & primitives, however contracts prefixed with exec
