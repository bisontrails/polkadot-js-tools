...
class ExtrinsicPayload extends _Base.default {
  ...
  static decodeExtrinsicPayload(registry, value) {
    ...
    return (0, _create.createType)(registry, VERSIONS[version] || VERSIONS[0], value, {
      version
    });
  }
  /**
  ...
  get genesisHash() {
    // NOTE only v3+
    return this.raw.genesisHash || (0, _create.createType)(this.registry, 'Hash');
  }
  /**
  ...
  get specVersion() {
    // NOTE only v3+
    return this.raw.specVersion || (0, _create.createType)(this.registry, 'u32');
  }
  /**
  ...
  get tip() {
    // NOTE from v2+
    return this.raw.tip || (0, _create.createType)(this.registry, 'Compact<Balance>');
  }
  /**
