...
function formattingTests(version, decorated, encodedValues) {
  ...
  describe("formatting with Metadata ".concat(version), () => {
    ...
    beforeEach(() => {
      ...
      api = new _.default(registry, provider);
    });
    it('encodes key (with params), decoding response', done => {
      api.state.getStorage([decorated.query.balances.freeBalance, ADDR_ONE]).subscribe(value => {
    ...
    it('returns the fallback result on not-found values', done => {
      api.state.getStorage([decorated.query.system.accountNonce, ADDR_ONE]).subscribe(value => {
        expect(value.toHex()).toEqual('0x00000000');
        done();
      });
    });
    it('encodes multiple keys, decoding multiple results', done => {
      api.state.subscribeStorage([[decorated.query.balances.freeBalance, ADDR_ONE], [decorated.query.balances.freeBalance, ADDR_TWO]]).subscribe(value => {
        // console.error(value);
    ...
    it('handles the case where Option<Bytes> are retrieved', done => {
      const call = Number(version.slice(1)) <= 5 ? decorated.query.contract.pristineCode : decorated.query.contracts.pristineCode;
    ...
    it('handles fallbacks for linked heads (new metadata only)', done => {
      const iterKey = decorated.query.staking.validators && decorated.query.staking.validators.iterKey; // skip for old

      if (!iterKey) {
        return done();
      }

      api.state.subscribeStorage([iterKey]).subscribe(value => {
    ...
    it('handles fallbacks for linked maps (new metadata only)', done => {
      ...
      api.state.subscribeStorage([[decorated.query.staking.validators, '0x00']]).subscribe((_ref2) => {
        let [value] = _ref2;
...
formattingTests('v3', new _metadata.default(registry, _static.default), ['0x4af2c53fce3ec33c6ccccf22e926f1a7', '0x3e62f7ed6e788e1337bce2a97b68a12a', '0x777519cd81f845abdb40d253923d6098']);
formattingTests('v4', new _metadata.default(registry, _static2.default), ['0xec8f96437274a883afcac82d01a9defeb68209cd4f2c084632813692aa5e65ad', '0x1dbb0224910f42a14e7f1406b24c6fe8157296691b02a78756e01946038fffab', '0xc7879f4faa637a90d782070a3cb6be99a9fb0316e19a0454ce93c4f0a34712f1']);
formattingTests('v5', new _metadata.default(registry, _static3.default), ['0xec8f96437274a883afcac82d01a9defeb68209cd4f2c084632813692aa5e65ad', '0x1dbb0224910f42a14e7f1406b24c6fe8157296691b02a78756e01946038fffab', '0xc7879f4faa637a90d782070a3cb6be99a9fb0316e19a0454ce93c4f0a34712f1']);
formattingTests('v6', new _metadata.default(registry, _static4.default), ['0xec8f96437274a883afcac82d01a9defeb68209cd4f2c084632813692aa5e65ad', '0x1dbb0224910f42a14e7f1406b24c6fe8157296691b02a78756e01946038fffab', '0xc7879f4faa637a90d782070a3cb6be99a9fb0316e19a0454ce93c4f0a34712f1']);
formattingTests('v7', new _metadata.default(registry, _static5.default), ['0xec8f96437274a883afcac82d01a9defeb68209cd4f2c084632813692aa5e65ad', '0x1dbb0224910f42a14e7f1406b24c6fe8157296691b02a78756e01946038fffab', '0xc7879f4faa637a90d782070a3cb6be99a9fb0316e19a0454ce93c4f0a34712f1']);
formattingTests('v8', new _metadata.default(registry, _static6.default), ['0xec8f96437274a883afcac82d01a9defeb68209cd4f2c084632813692aa5e65ad', '0x1dbb0224910f42a14e7f1406b24c6fe8157296691b02a78756e01946038fffab', '0xc7879f4faa637a90d782070a3cb6be99a9fb0316e19a0454ce93c4f0a34712f1']);